    ...
    const certificatesData = [
      {
        ...
        verificationUrl: 'https://ithunt.vercel.app/api/certificates/verify/ITH-CERT-2026-001'
      },
      {
        ...
        authorizedSignatory: 'Er. Lakshman Singh Chauhan',
        status: 'Verified & Active',
        verificationUrl: 'https://ithunt.vercel.app/api/certificates/verify/ITH-CERT-2026-002'
      },
      {
        ...
        authorizedSignatory: 'Er. Lakshman Singh Chauhan',
        status: 'Verified & Active',
        verificationUrl: 'https://ithunt.vercel.app/api/certificates/verify/ITH-CERT-2026-003'
      },
      {
        certNo: 'ITH-EXP-2026-081',
        certificateNumber: 'ITH-EXP-2026-081',
        type: 'experience',
        studentName: 'Anup Mishra',
        candidateName: 'Anup Mishra',
        role: 'Lead Full Stack & Cloud Developer Intern',
        designation: 'Lead Full Stack & Cloud Developer Intern',
        department: 'Software Engineering & Cloud Architecture',
        course: 'MERN & Cloud Software Engineering Internship',
        duration: '6 Months',
        startDate: '01/09/2025',
        endDate: '28/02/2026',
        technologies: 'React.js, Vue 3, Node.js, Express, MongoDB, Docker, REST APIs',
        performance: 'Outstanding & Highly Commended',
        grade: 'Grade O (Outstanding)',
        issueDate: '01/03/2026',
        authorizedSignatory: 'Er. Lakshman Singh Chauhan',
        status: 'Verified & Active',
        verificationUrl: 'https://ithunt.vercel.app/api/certificates/verify/ITH-EXP-2026-081'
      },
      {
        certNo: 'ITH-EXP-2026-082',
        certificateNumber: 'ITH-EXP-2026-082',
        type: 'experience',
        studentName: 'Rohan Verma',
        candidateName: 'Rohan Verma',
        role: 'Backend & Cloud API Developer Intern',
        designation: 'Backend & Cloud API Developer Intern',
        department: 'Backend Systems & Distributed Databases',
        course: 'Node.js & Cloud Microservices Internship',
        duration: '6 Months',
        startDate: '15/08/2025',
        endDate: '15/02/2026',
        technologies: 'Node.js, Express, MongoDB, Mongoose, Redis, JWT Auth, Linux',
        performance: 'Excellent & Commendable',
        grade: 'Grade A+ (Distinction)',
        issueDate: '20/02/2026',
        authorizedSignatory: 'Er. Lakshman Singh Chauhan',
        status: 'Verified & Active',
        verificationUrl: 'https://ithunt.vercel.app/api/certificates/verify/ITH-EXP-2026-082'
      }
    ];
